...
export const WhatsAppButton = () => {
  ...
  const message = encodeURIComponent(
    `Hi! I'm a vendor checking the UPCYCLE marketplace.\n\nCurrently there are *${productCount} products* listed.\n\nVisit: https://sustainable-fashion-marketplace.netlify.app/buyer`
  );
